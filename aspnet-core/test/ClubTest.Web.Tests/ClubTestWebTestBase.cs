...
{
    public abstract class ClubTestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ClubTestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ClubTestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ClubTestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ClubTestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ClubTestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ClubTestDbContext, Task<T>> func)
        {
            T result;
